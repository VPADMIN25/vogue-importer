<?php
// migrate_02_add_missing_gids.php
// Cél: Hozzáadja a hiányzó Shopify GID oszlopokat.
...
$columns_to_add = [
    ...
    "shopifyinventoryid" => "VARCHAR(255) NULL"
];
...
if ($all_successful) {
    echo "<h2>✅ GID oszlopok sikeresen hozzáadva.</h2>";
}
$conn->close();
?>
