<?php
// index2new.php – V16 – TELJES ADATOK + LIMIT NÉLKÜL + SÚLY JAVÍTVA
ini_set('max_execution_time', 300);
date_default_timezone_set('Europe/Budapest');
echo "<pre style='font-family:Consolas;font-size:14px'><h2>2. LÉPÉS – ÚJ TERMÉKEK (V16 – TELJES ADATOK)</h2>";
...
while ($g = $groups->fetch_assoc()) {
    ...
    // --- HANDLE generátor (50 próbálkozás) ---
    ...
    while ($r = $res->fetch_assoc()) {
        ...
        // Variánsok – SÚLY JAVÍTVA: grams → kg
        $variants[] = [
            "sku" => $r['generated_sku'] ?? '',
            ...
            "weight" => (float)($r['grams'] / 1000 ?? 0),  // JAVÍTVA!
